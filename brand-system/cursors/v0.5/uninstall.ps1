# Crow Talon v0.5 per-user cursor scheme uninstaller.
[CmdletBinding(SupportsShouldProcess)]
param()

$ErrorActionPreference = 'Stop'
$schemeName = 'Crow Talon v0.5'
$destination = Join-Path $env:LOCALAPPDATA 'Crow\Cursors\Crow-Talon-v0.5'
...
if ($removed) {
    Write-Host 'Crow Talon v0.5 has been removed from this Windows account.'
} else {
